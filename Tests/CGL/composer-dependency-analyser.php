...
$configuration
    ...
    // posix stays undeclared on purpose: its call site skips the test when the
    // extension is missing, so requiring it would turn an optional check into a
    // hard dependency of the test suite.
