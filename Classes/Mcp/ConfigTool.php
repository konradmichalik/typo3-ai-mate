...
final readonly class ConfigTool
{
    ...
    /**
     * @param string|null   $path    slash-separated path into the section, e.g. FE, SYS/features, my_ext; omit for a compact default (top-level keys plus feature toggles for confvars, all keys for features, extension keys with configuration for extension)
