...
final readonly class InfoTool
{
    ...
    #[McpTool(name: 'typo3-info', title: 'TYPO3 Info', description: 'Call this first. The session entry point: exact TYPO3 version and major (v13 vs v14 governs almost every other recommendation), PHP version, application context, database platform/version, active extensions split into own vs. third-party, relevant package versions, profiler CLI availability/version/active state, and a compact tt_content type inventory (CTypes, plus list_type plugins on v13 only). Read this before anything else to avoid guessing from composer.json, which fails on this package\'s own constraint style (^13.4 || ^14.3).')]
